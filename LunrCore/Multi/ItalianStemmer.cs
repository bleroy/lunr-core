namespace Lunr.Multi
{
    public sealed class ItalianStemmer : StemmerBase
    {
        ...
        private static readonly int[] g_AEIO;
        private static readonly int[] g_CG;
        ...
        private void r_prelude()
        {
            ...
            {
                sbp.bra = sbp.cursor;
                var among_var = sbp.find_among(a_0, 7);
                if (among_var != 0) /* !! */
                {
                    sbp.ket = sbp.cursor;
                    switch (among_var)
        ...
        private void r_postlude()
        {
            ...
            {
                sbp.bra = sbp.cursor;
                var among_var = sbp.find_among(a_1, 3);
                if (among_var == 0) /* !! */
                    break;
                sbp.ket = sbp.cursor;
                switch (among_var)
        ...
        private void r_attached_pronoun()
        {
            ...
            {
                sbp.bra = sbp.cursor;
                var among_var = sbp.find_among_b(a_3, 5);
                if (among_var != 0 /* !! */ && r_RV())
                {
                    switch (among_var)
                    {
        ...
        {
            sbp.ket = sbp.cursor;
            var among_var = sbp.find_among_b(a_6, 51);
            if (among_var == 0) /* !! */
                return false;
            sbp.bra = sbp.cursor;
            switch (among_var)
        ...
        private void r_verb_suffix()
        {
            if (sbp.cursor >= I_pV)
            {
                ...
                sbp.ket = sbp.cursor;
                var among_var = sbp.find_among_b(a_7, 87);
                if (among_var != 0) /* !! */
                {
                    sbp.bra = sbp.cursor;
                    if (among_var == 1)
