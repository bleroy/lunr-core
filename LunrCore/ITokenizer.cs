...
namespace Lunr
{
    public interface ITokenizer
    {
        ...
        /// added as metadata to every token that is created from the object to tokenize.</param>
        /// <param name="culture">The culture to use to tokenize.</param>
        /// <param name="separator">An optional function that returns tru if a character is a separator</param>
